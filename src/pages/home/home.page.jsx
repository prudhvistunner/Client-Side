...
// this method will run after component rendered
    componentDidMount() {
...
// In this method we will create transaction and we will call course service method
    enroll(course) {
        ...
        var transaction = Transaction(this.state.currentUser.id, course); // then we will call course service method
